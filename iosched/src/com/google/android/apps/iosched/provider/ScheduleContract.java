...
/**
 * Contract class for interacting with {@link com.google.android.apps.iosched.provider.ScheduleProvider}. Unless
...
public class ScheduleContract {
    ...
    public static class Blocks implements BlocksColumns, BaseColumns {
        ...
        /**
         * Build {@link android.net.Uri} that references starred {@link Sessions} associated
         * with the requested {@link #BLOCK_ID}.
         */
    ...
    public static class Tracks implements TracksColumns, BaseColumns {
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link com.google.android.apps.iosched.provider.ScheduleContract.Sandbox} associated with
    ...
    public static class Sessions implements SessionsColumns, BlocksColumns, RoomsColumns,
        ...
        /**
         * Build {@link android.net.Uri} that includes track detail with list of sessions.
         */
        ...
        /**
         * Build {@link android.net.Uri} that includes track detail for a specific session.
         */
        ...
        /**
         * Build {@link android.net.Uri} that references any {@link Tracks} associated with
    ...
    public static class Sandbox implements SandboxColumns, SyncColumns, BlocksColumns, RoomsColumns, BaseColumns {
        ...
        /** Build {@link android.net.Uri} for requested {@link #COMPANY_ID}. */
        public static Uri buildCompanyUri(String companyId) {
            return CONTENT_URI.buildUpon().appendPath(companyId).build();
        }

        /** Read {@link #COMPANY_ID} from {@link com.google.android.apps.iosched.provider.ScheduleContract.Sandbox} {@link android.net.Uri}. */
    ...
    public static class MapMarkers implements MapMarkerColumns, BaseColumns {
        ...
        /** Read {@link #FLOOR} from {@link MapMarkers} {@link android.net.Uri}. */
